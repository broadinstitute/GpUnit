...
/**
 * Class representing test assertions which should be validated on the server.
 *  
 * @author cnorman
 */

// TODO: this has too much code overlap with GpAssertions

public class RemoteAssertions {
    private int exitCode = 0;
    private String jobStatus = "success";
    private int numFiles = -1;
    private Map<String,RemoteFileObj> files;
    ...
    */
    ...
    public Map<String,RemoteFileObj> getFiles() {
        return this.files;
    }
    public void setFiles(Map<String,RemoteFileObj> files) {
        this.files = files;
    }
